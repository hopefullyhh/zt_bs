...
<link href="${PATH }/resources/css/materialdesignicons.min.css" rel="stylesheet">
      ...
      <div class="lyear-layout-sidebar-scroll"> 
        ...
        <nav class="sidebar-main">
          <ul class="nav nav-drawer">
            ...
            <li class="nav-item nav-item-has-subnav">
              <a href="javascript:void(0)"><i class="mdi mdi-menu"></i> 公告管理</a>
              <ul class="nav nav-subnav">
                <li> <a href="#!">公告查询</a> </li>               
                <li> <a href="#!">添加公告</a> </li>
              </ul>
            ...
            <li class="nav-item nav-item-has-subnav">
              <a href="javascript:void(0)"><i class="mdi mdi-menu"></i> 下载管理</a>
              <ul class="nav nav-subnav">
                <li> <a href="#!">文档查询</a> </li>
                <li> <a href="#!">文档下载</a> </li>
              </ul>
          ...
          <ul class="topbar-right">
            <li class="dropdown dropdown-profile">
              <a href="javascript:void(0)" data-toggle="dropdown">
                <img class="img-avatar img-avatar-48 m-r-10" src="${PATH }/resources/images/users/avatar.jpg" alt="笔下光年" />
...
<script type="text/javascript" src="${PATH }/resources/js/perfect-scrollbar.min.js"></script>
<script type="text/javascript" src="${PATH }/resources/js/main.min.js"></script>

<!--图表插件-->
<script type="text/javascript" src="${PATH }/resources/js/Chart.js"></script>
